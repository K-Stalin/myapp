          ...
          children: [
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("AdminID: ${adminProfile["user_name"]}")
                  ],
                ),
              ),
            ),
            ...
            _buildDrawerItem(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => AddStockspage()),
                );
              },
            ),
                ...
                child: ListView(
                  children: [
                    ...
                    _buildTableRow("#1236", "Alice", "Cancelled"),
                     Divider(),
                    _buildTableRow("#1236", "Alice", "Completed"),
                     Divider(),
                    _buildTableRow("#1236", "Alice", "Pending"),
                  ],
                ),
              ),
            ),
