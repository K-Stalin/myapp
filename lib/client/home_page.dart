...
class _ClientHomePageState extends State<ClientHomePage> {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Center(
          child: Text(
            'FlatTrade',
            style: TextStyle(color: Color(0XFF613DE4),fontWeight: FontWeight.bold),
          ),
        ),
      ),
      drawer: Drawer(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {},
                    child: Text("+ Add money", style: TextStyle(color: Colors.blue)),
                  ),
                ],
              ),
            ),
              ...
              child: Column(
                children: [
                  _DrawerMenuItem("Orders", Icons.shopping_cart, () async
                  {
                     ...
                     Navigator.push(context, MaterialPageRoute(builder: (context)=>OrderPage(clientID:userID)));
                  }),
  ...
  context,
  MaterialPageRoute(
    builder: (context) => BuyPage(stock: stockDataSet[index],client:LogedUserProfile),
  ),
);
          ...
          else
          {
                 ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(content: Text("KYC failed. Please Verify That.")),
                                    );
          }               
...
setState(() {
  ...
  context,
  MaterialPageRoute(
    builder: (context) =>  SellPage(stock: stockDataSet[index],client:LogedUserProfile),
  ),
);
