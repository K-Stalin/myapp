            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  Color tradeColor =
                      tradeType.toUpperCase() == "SELL"
                          ? Colors.red
                          : Colors.green;
   if(
    
    dataSet[index]["backOfficer_approve"]=="Approved"
      &&
    dataSet[index]["biller_approve"]=="Approved"
     &&
     dataSet[index]["approver"]=="Approved"
   ){
                  return Container(
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              dataSet[index]["trade_date"].toString().substring(
                                    0,
                                    10,
                                  ) ??
                                  "",
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              getStocks[0]["resp"].firstWhere(
                                (element) =>
                                    element["stock_id"] ==
                                    dataSet[index]["stock_id"],
                                orElse: () => {"stock_name": "unknown"},
                              )["stock_name"].toString().isEmpty ? "XYZ" :getStocks[0]["resp"].firstWhere(
                                (element) =>
                                    element["stock_id"] ==
                                    dataSet[index]["stock_id"],
                                orElse: () => {"stock_name": "unknown"},
                            ...
                            Row(
                              children: [
                                Icon(Icons.circle, size: 5, color: tradeColor),
                                SizedBox(width: 5),
